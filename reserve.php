						...
						<div class = "row" style = "margin-bottom: 20px;">
							<div class = "col-md-3 reservation_cards">
								<p>
									...
									<span>Date de ramassage :</span><?php echo $_SESSION['pickup_date']; ?>
								</p>
							</div>
							<div class = "col-md-3 reservation_cards">
								<p>
									<i class="fas fa-calendar-alt"></i>
									<span>Date de retour : </span><?php echo $_SESSION['return_date']; ?>
								</p>
							</div>
							<div class = "col-md-3 reservation_cards">
								<p>
									<i class="fas fa-map-marked-alt"></i>
									<span>Lieu de ramassage :</span><?php echo $_SESSION['pickup_location']; ?>
								</p>
							</div>
							<div class = "col-md-3 reservation_cards">
								<p>
									<i class="fas fa-map-marked-alt"></i>
									<span>Lieu de retour : </span><?php echo $_SESSION['return_location']; ?>
								</p>
							</div>
						</div>
						<div class = "row">
							...
							<div class = "col-md-5">
								<div class = "client_details">
									...
									<div class = "form-group">
										<label for="client_phonenumber">Numéro de téléphone</label>
									...
									<button type="submit" class="btn sbmt-bttn" name = "submit_reservation">Réservez instantanément</button>
								</div>
							</div>
						</div>
					</form>
			...
			else
			{
				?>
					<div style = "max-width:500px; margin:auto;">
						...
						Veuillez sélectionner la première date de ramassage et de retour.
						</div>
						<button class = "btn btn-info" style = "display:block;margin:auto">
							<a href="./#reserve" style = "color:white">Page d'accueil</a>
						</button>
					</div>
				<?php
			}
